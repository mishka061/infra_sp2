# Generated by Django 2.2.28 on 2022-11-19 13:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.IntegerField(validators=[reviews.validators.validate_future_year], verbose_name='Дата выхода')),
                ...
                ('genre', models.ManyToManyField(related_name='genretitles', through='reviews.GenreTitle', to='reviews.Genre', verbose_name='жанр')),
            ],
            options={
        ...
        migrations.AddConstraint(
            model_name='user',
            constraint=models.UniqueConstraint(fields=('username', 'email'), name='unique_reg_user'),
        ),
    ]
